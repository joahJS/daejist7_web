...
<link rel="stylesheet" href="/daejiM/resources/view/css/menu.css" />
<script src="/daejiM/resources/view/js/menu/menu.js?v=<%=System.currentTimeMillis()%>"></script>

	<div id="wrap">
        <main id="mainWrap">
            <xml version="1.0" encoding="UTF-8"><svg id="logoBackground" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 110.11 75.65">
                    <defs>
                        <style>
                            .cls-1 {
                                fill: #fff;
                        ...
                        <linearGradient id="_무제_그라디언트_15" x1="0" y1="42.34" x2="110.11" y2="42.34"
                ...
                <div id="contentView">
                        ...
                        <div id="frmBTN">
                            ...
                            <button onclick="location.href='/exe/mgtRpt'"><i class="ri-calendar-2-line"></i>MIS</button>
                            ...
                            <span class="logout" onclick="location.href='/daejiM/login/logout.do'">로그아웃</span>
                        </div>
