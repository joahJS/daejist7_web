        ...
        <link rel="stylesheet" href="/daejiM/resources/view/css/login.css" />
        <script src="/daejiM/resources/view/js/login/login.js?v=<%=System.currentTimeMillis()%>" defer></script>
        ...
        <div id="wrap">
            <main id="mainWrap">
                ...
                <div id="contentView">
                    ...
                    <form id="frmLogin" action="/daejiM/login/loginChk.do" method="post">
                        <input type="text" name="username" id="usrid" placeholder="ID" maxlength="20">
                        <input type="password" name="password" id="usrpw" placeholder="Password" maxlength="16">
